...
const command: ButtonActionMessage = {
    ...
    execute: async (interaction) => {
        ...
        interaction.reply({content: "L'obtention automatique des roles n'est plus disponible, veuillez contacter un administrateur pour obtenir votre role.", ephemeral: true})
    }
}
